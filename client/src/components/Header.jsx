  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div >
            ...
            Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br className='max-md:hidden' /> Lorem Ipsum has been the industry's standard dummy text ever.
            </p>
            <div>
